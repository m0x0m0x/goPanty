...
echo "Get the latest binary from https://go.dev/dl/ a the time of writing it is 1.21.3 which will be downloaded "
echo " 1.21.1 - https://go.dev/dl/go1.21.3.linux-amd64.tar.gz"
echo ""
